...
export declare const DEPLOY_DLL = "deploy-dll";
export declare const DEPLOY_DLL_ERROR = "deploy-dll-error";
export declare const DEPLOYED_DLL = "deployed-dll";
export declare const RESET_DLL = "reset-dll";
export declare const DEPLOY_ATTRIBUTE_STORE = "deploy-attribute-store";
export declare const DEPLOY_ATTRIBUTE_STORE_ERROR = "deploy-attribute-store-error";
export declare const DEPLOYED_ATTRIBUTE_STORE = "deployed-attribute-store";
export declare const RESET_ATTRIBUTE_STORE = "reset-attribute-store";
