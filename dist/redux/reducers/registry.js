...
const handlers = {
    ...
    [registry_1.REGISTRY_APPLY_OK]: (state, { payload }) => (Object.assign({}, state, { loading: false, data: Object.assign({}, state.data, { listings: Object.assign({}, state.data.listings || {}, { [payload.listingHash]: payload }) }) })),
    ...
    [registry_1.REGISTRY_CHALLENGE_OK]: (state, { payload }) => (Object.assign({}, state, { loading: false, data: Object.assign({}, state.data, { challenges: Object.assign({}, state.data.challenges, { [payload.id]: payload }) }) })),
